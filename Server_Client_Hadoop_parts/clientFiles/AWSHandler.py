...
class AWSHandler :
    ...
    def upload_file_to_bucket(self,filename,dst_file = ""):
        ...
        dst_file = pathFile[len(pathFile)-1] if dst_file == "" else dst_file
    ...
    def download_file_from_bucket(self,filename,dest = ""):
        dest = dest if dest != "" else filename
        self.bucket_client.download_file(self.bucket, filename, dest)
